...
namespace TierSpawnConfig
{
    ...
    internal class PluginLoader : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            tier1EnemyCount = StaticConfig.Bind("Spawn Count", "Tier 1", 10, new ConfigDescription("How many tier 1 enemies should be spawned? -1 = Vanilla, 0 = None", new AcceptableValueRange<int>(-1, 500)));
            tier2EnemyCount = StaticConfig.Bind("Spawn Count", "Tier 2", 10, new ConfigDescription("How many tier 2 enemies should be spawned? -1 = Vanilla, 0 = None", new AcceptableValueRange<int>(-1, 500)));
            tier3EnemyCount = StaticConfig.Bind("Spawn Count", "Tier 3", 10, new ConfigDescription("How many tier 3 enemies should be spawned? -1 = Vanilla, 0 = None", new AcceptableValueRange<int>(-1, 500)));
            tier3EnemyGroups = StaticConfig.Bind("Spawn Count", "Tier 3 Groups", false, "Should tier 3 spawn groups be enabled? These are groups of lower tier enemies that sometimes replace the spawn of a tier 3 enemy.");
            blacklistedEnemies = StaticConfig.Bind("Spawn Count", "Blacklisted Enemies", "Enemy - Ceiling Eye,Enemy - Hidden,Enemy - Thin Man", "Which enemies should be disabled? This is a comma-separated list of enemy spawn groups. For the full list check the mod's thunderstore page.");
