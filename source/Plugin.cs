...
namespace TierSpawnConfig
{
    ...
    internal class PluginLoader : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            tier1EnemyCount = StaticConfig.Bind("Spawn Count", "Tier 1", 10, new ConfigDescription("How many tier 1 enemy groups should be spawned? -1 = Vanilla, 0 = None", new AcceptableValueRange<int>(-1, 500)));
            tier2EnemyCount = StaticConfig.Bind("Spawn Count", "Tier 2", 10, new ConfigDescription("How many tier 2 enemy groups should be spawned? -1 = Vanilla, 0 = None", new AcceptableValueRange<int>(-1, 500)));
            tier3EnemyCount = StaticConfig.Bind("Spawn Count", "Tier 3", 10, new ConfigDescription("How many tier 3 enemy groups should be spawned? -1 = Vanilla, 0 = None", new AcceptableValueRange<int>(-1, 500)));
